...
public class ElectricFurnaceScreen extends AbstractContainerScreen<ElectricFurnaceMenu> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        MicroTechGuiHelper.drawStatus(guiGraphics, this.font, 8, 20, MicroTechGuiHelper.getElectricFurnaceStatus(this.menu));
        ...
        guiGraphics.drawString(this.font, Component.translatable("gui.microtech.electric_furnace_t1.input"), 50, 54, 0xFFFFFF, false);
        guiGraphics.drawString(this.font, Component.translatable("gui.microtech.electric_furnace_t1.output"), 118, 54, 0xFFFFFF, false);
